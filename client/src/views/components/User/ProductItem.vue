    ...
    <div class="product-card">
      ...
      <div class="product-info">
          ...
          <div class="product-price">
                ...
                <div v-else>
                    <span class="price">{{ props.product.price * 22 }}  ₽</span>
                </div>

                <div v-if="productQuantity > 0" class="quantity-controls">
                    <button @click="cart.decreaseItem(props.product)" class="quantity-btn minus-btn">
                        <i class="fas fa-minus"></i>
                    </button>
                    <div class="quantity-display">{{ productQuantity }}</div>
                    <button @click="cart.addItem(props.product)" class="quantity-btn plus-btn">
                        <i class="fas fa-plus"></i>
                    </button>
                </div>

                <button v-else @click="cart.addItem(props.product)" class="add-to-cart">
